    ...
    <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex items-start mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-400 mb-4">
              {t("i18nexus 코어 라이브러리와 CLI 도구를 설치합니다")}
            </p>
          </div>
        </div>
      ...
      <div className="mb-10">
        <div className="flex items-start mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-400 mb-4">
              {t("기존 코드의 모든 한국어를 자동으로 t() 함수로 래핑합니다")}
            </p>
          </div>
        </div>
      ...
      <div className="mb-10">
        <div className="flex items-start mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-400 mb-4">
              {t(
                "모든 t() 함수 호출에서 키를 추출하여 en.json, ko.json 생성/업데이트"
              )}
            </p>
          </div>
        </div>
      ...
      <div className="mb-10">
        <div className="flex items-start mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-slate-400 mb-4">
              {t("layout.tsx에 I18nProvider를 설정합니다")}
            </p>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-r from-green-950/50 to-emerald-950/50 rounded-2xl border border-green-800/50 p-10 text-center">
        ...
        <div className="flex justify-center gap-4">
          ...
          <Link
            href="/provider"
            className="px-6 py-3 border border-slate-600 text-slate-300 rounded-lg font-semibold hover:bg-slate-800 transition-colors">
            {t("Provider 가이드 →")}
          </Link>
        </div>
      </div>

    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="text-center mb-24">
        ...
        <p className="text-2xl md:text-3xl text-slate-300 mb-4 font-light">
          {t("완전한 React i18n 자동화 툴킷")}
        </p>
        <p className="text-lg text-slate-400 max-w-3xl mx-auto leading-relaxed mb-10">
          {t(
            "하드코딩된 한국어를 자동으로 감지하여 t() 함수로 래핑하고, 번역 파일을\n          관리하는 완전 자동화된 국제화 솔루션입니다."
          )}
        </p>
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Link
            href="/quickstart"
            className="px-8 py-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all shadow-lg shadow-blue-500/30 hover:shadow-blue-500/50 hover:scale-105">
            {t("빠른 시작 →")}
          </Link>
          <Link
            href="/detail"
            className="px-8 py-4 border-2 border-slate-600 text-slate-300 rounded-xl font-semibold hover:bg-slate-800 hover:border-slate-500 transition-all">
            {t("상세 설명")}
          </Link>
        </div>
      </div>
      ...
      <section className="mb-20">
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 text-lg">
            {t("t-wrapper가 실시간으로 코드를 변환하는 과정")}
          </p>
        </div>
        ...
        <div className="bg-slate-900 rounded-2xl border border-slate-700 p-8">
          ...
          <p className="text-slate-400 text-center mt-4 text-sm">
            {t(
              "💡 자동으로 import 추가 → useTranslation 훅 주입 → 한국어 텍스트 래핑"
            )}
          </p>
        </div>
      </section>
      ...
      <section className="mb-20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Link
            href="/quickstart"
            className="group bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl border border-slate-700 hover:border-blue-500 p-6 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20 hover:-translate-y-1">
          ...
          <Link
            href="/tool"
            className="group bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl border border-slate-700 hover:border-indigo-500 p-6 transition-all duration-300 hover:shadow-lg hover:shadow-indigo-500/20 hover:-translate-y-1">
          ...
          <Link
            href="/provider"
            className="group bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl border border-slate-700 hover:border-purple-500 p-6 transition-all duration-300 hover:shadow-lg hover:shadow-purple-500/20 hover:-translate-y-1">
          ...
          <Link
            href="/detail"
            className="group bg-gradient-to-br from-slate-900 to-slate-800 rounded-2xl border border-slate-700 hover:border-pink-500 p-6 transition-all duration-300 hover:shadow-lg hover:shadow-pink-500/20 hover:-translate-y-1">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="bg-gradient-to-br from-blue-950/50 to-blue-900/30 border border-blue-800/50 rounded-xl p-6">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              {t(
                "수동으로 하나하나 t() 함수를 추가할 필요 없이, CLI 도구가 자동으로 모든 한국어 텍스트를 감지하고 변환합니다."
              )}
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-indigo-950/50 to-indigo-900/30 border border-indigo-800/50 rounded-xl p-6">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              {t(
                "Next.js App Router와 완벽하게 통합되어 하이드레이션 문제가 전혀 없습니다. 쿠키 기반 언어 관리로 첫 렌더링부터 올바른 언어를 표시합니다."
              )}
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-purple-950/50 to-purple-900/30 border border-purple-800/50 rounded-xl p-6">
            ...
            <p className="text-slate-400 text-sm leading-relaxed">
              {t(
                "복잡한 설정 없이 바로 시작할 수 있습니다. TypeScript 완벽 지원으로 타입 안전성을 보장하며, 직관적인 API를 제공합니다."
              )}
            </p>
          </div>
        </div>
